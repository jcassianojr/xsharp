#region DEFINES
STATIC DEFINE JRDF_HD := 108 
STATIC DEFINE JRDF_HT := 107 
STATIC DEFINE JRDF_MEDIA := 117 
STATIC DEFINE JRDF_NOME := 103 
STATIC DEFINE JRDF_NUMERO := 102 
STATIC DEFINE JRDF_PE := 114 
STATIC DEFINE JRDF_PP := 115 
STATIC DEFINE JRDF_PU := 113 
STATIC DEFINE JRDF_QP := 109 
STATIC DEFINE JRDF_SC_HD := 105 
STATIC DEFINE JRDF_SC_HT := 104 
STATIC DEFINE JRDF_SC_MEDIA := 116 
STATIC DEFINE JRDF_SC_NOME := 100 
STATIC DEFINE JRDF_SC_NUMERO := 101 
STATIC DEFINE JRDF_SC_PE := 111 
STATIC DEFINE JRDF_SC_PP := 112 
STATIC DEFINE JRDF_SC_PU := 110 
STATIC DEFINE JRDF_SC_QP := 106 
#endregion

class JRDF inherit DATAWINDOW 
